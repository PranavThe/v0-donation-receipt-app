...
// forwardRef so DonationForm can pass a ref to the white document div
// and html2canvas can screenshot exactly what the user sees
export const ReceiptPreview = forwardRef<HTMLDivElement, ReceiptPreviewProps>(
  function ReceiptPreview(
    { firstName, lastName, email, address, donationAmount, donationDate, paymentMethod, note, receiptNumber },
    ref
  ) {
    ...
    return (
      <div className="bg-card rounded-lg border border-border shadow-sm overflow-hidden">
        {/* Panel bar — excluded from PDF capture since ref is on the inner div */}
        <div className="bg-muted/50 px-4 py-2 border-b border-border flex items-center gap-2">
          <FileText className="w-4 h-4 text-muted-foreground" />
          <span className="text-sm font-medium text-muted-foreground">Receipt Preview</span>
        </div>

        {/* ref attached here — only the white document gets captured */}
        <div ref={ref} className="bg-white" style={{ fontFamily: "'Georgia', 'Times New Roman', serif" }}>
          {!hasMinimalData ? (
            ...
            <div className="px-8 py-7">
              ...
              <div className="flex items-center justify-between pb-4" style={{ borderBottom: `2.5px solid ${RED}` }}>
                ...
                <div className="text-right">
                  <p className="font-bold tracking-wide" style={{ fontSize: 15, color: RED, fontFamily: "system-ui" }}>
                    {ORG_INFO.name}
                  </p>
              ...
              <div className="text-center py-4">
                <p className="font-bold tracking-[0.2em] uppercase" style={{ fontSize: 13, color: DARK, fontFamily: "system-ui" }}>
                  Official Donation Receipt
                </p>
                <div className="flex justify-center items-center gap-3 mt-1">
                  <div style={{ height: 1, width: 40, backgroundColor: GOLD }} />
                  <p style={{ fontSize: 8.5, color: LITE, letterSpacing: "0.05em", fontFamily: "system-ui" }}>
              ...
              <div className="mb-5 rounded" style={{ border: `1px solid #d9cfc4`, backgroundColor: WARM }}>
                <div className="flex" style={{ borderBottom: `1px solid #d9cfc4` }}>
                  ...
                  <div className="px-4 py-2.5" style={{ minWidth: 130 }}>
                    ...
                    <p className="font-bold mt-0.5" style={{ fontSize: 11, color: DARK, fontFamily: "system-ui" }}>
                ...
                <div className="flex">
                  ...
                  <div className="px-4 py-2.5" style={{ minWidth: 130 }}>
                    ...
                    <p className="mt-0.5" style={{ fontSize: 10, color: MID, fontFamily: "system-ui" }}>
                      {donationDate ? format(donationDate, "MMMM d, yyyy") : "—"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              {/* === DONOR SECTION === */}
              <div className="mb-5">
                <p style={{ fontSize: 7.5, color: LITE, letterSpacing: "0.12em", textTransform: "uppercase", fontFamily: "system-ui", marginBottom: 6 }}>
              ...
              <table className="w-full mb-1" style={{ borderCollapse: "collapse", fontSize: 10 }}>
                ...
                <tbody>
                  <tr style={{ backgroundColor: WARM, borderBottom: `1px solid #e8dfd3` }}>
                    ...
                    <td style={{ padding: "9px 10px", color: DARK, fontFamily: "system-ui" }}>
                      {note || "General Donation"}
                    </td>
                    <td style={{ padding: "9px 10px", color: DARK, fontFamily: "system-ui", textAlign: "right", fontVariantNumeric: "tabular-nums" }}>
                ...
                <tfoot>
                  <tr style={{ backgroundColor: "#f0ebe2", borderTop: `1.5px solid ${RED}` }}>
                    <td colSpan={2} style={{ padding: "8px 10px", fontFamily: "system-ui", fontWeight: 700, fontSize: 10, color: DARK, textAlign: "right", letterSpacing: "0.05em" }}>
                      TOTAL
                    </td>
                    <td style={{ padding: "8px 10px", fontFamily: "system-ui", fontWeight: 700, fontSize: 11, color: RED, textAlign: "right", fontVariantNumeric: "tabular-nums" }}>
                      ${displayAmount.toLocaleString("en-US", { minimumFractionDigits: 2 })}
                    </td>
                  </tr>
                </tfoot>
              ...
              <div className="flex items-baseline gap-2 mb-6 mt-2 pb-4" style={{ borderBottom: `1px solid #e0d8ce` }}>
                <span style={{ fontSize: 8, color: LITE, fontFamily: "system-ui", textTransform: "uppercase", letterSpacing: "0.1em", flexShrink: 0 }}>
                  Amount in Words:
                </span>
                <span style={{ fontSize: 9.5, color: DARK, fontStyle: "italic" }}>
